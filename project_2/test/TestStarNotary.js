...
it('can add the star name and star symbol properly', async() => {
    ...
    assert.equal(name, 'CryptoStar Token');
...
it('lets a user transfer a star', async() => {
    ...
    // 1. create a Star with different tokenId
    let starId = 9;
    await instance.createStar('transferred star', starId, {from: user1});
...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    assert.equal(await instance.lookUptokenIdToStarInfo(starId), 'lookup star');
});